...
fruits_with_more_than_two_vowels = [fruit for fruit in fruits if sum(list (map(fruit.lower( ).count, 'aeiou'))) > 2]

# Exercise 4 - make a variable named fruits_with_only_two_vowels. The result should be ['mango', 'kiwi', 'strawberry']
fruits_with_only_two_vowels = [fruit for fruit in fruits if sum(list (map(fruit.lower( ).count, 'aeiou'))) == 2]
...
numbers_with_two_numerals = [num for num in numbers if len(str(num)) >= 2]
